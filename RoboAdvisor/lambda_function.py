    ...
    if age is not None:
        ...
        if age <= 0:
            return build_validation_result(
                ...
                "age",
                "Your age is invalid, "
                "please provide a different age to continue.",
            )
        elif age >= 65:
            return build_validation_result(
                False,
                "age",
                "I'm sorry, your age is preventing us from opening an account, "
                "If you believe this is a mistake, please provide a different age",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "Your investment amount does not meet our requirements, "
                "please invest more to continue.",
            )
